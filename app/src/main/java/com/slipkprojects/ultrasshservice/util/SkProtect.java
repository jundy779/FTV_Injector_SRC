...
import com.art.vpn.BuildConfig;
...
public class SkProtect {
 ...
 //This Protections apps dont remove this code !!!


	private static final String APP_BASE = "com.ftv.injector";
	...
	public void simpleProtect() {
		if (!APP_BASE.equals(mContext.getPackageName().toLowerCase()) ||
			!mContext.getString(R.string.app_name).toLowerCase().equals("ftv injector")) {
			throw new RuntimeException();
		}
	}
